<?php
class code_clicaptcha{
    function __construct(){
        header("Content-type: text/html; charset=utf-8");
        error_reporting(E_ERROR | E_WARNING | E_PARSE);
    }
    public function creat(){
        $img1 = YZMPHP_PATH.'common/static/images/code_bg1.jpg';
        $img2 = YZMPHP_PATH.'common/static/images/code_bg2.jpg';
        $img3 = YZMPHP_PATH.'common/static/images/code_bg3.jpg';
        $font = YZMPHP_PATH.'common/static/images/SourceHanSansCN-Normal.otf';
        $imagePathArr = array($img1, $img2, $img3);
